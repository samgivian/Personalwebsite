...
window.addEventListener("scroll", function (e) {
  ...
  if (!ticking) {
    window.requestAnimationFrame(function () {
      ...
      ticking = false;
      if (
        last_known_scroll_position > screen_height / 7 &&
        section1_animaton == false
      ) {
      ...
      if ( section2_animaton == false && section2_counter==0) {
        if (
          last_known_scroll_position >
          screen_height / 5.5 + section1_height
        ) {
      ...
      if (section3_animaton == false && section3_counter==0) {
        if (
          last_known_scroll_position >
          screen_height / 5.5 + section1_height + section2_height
        ) {
